...
Dota2.Dota2Client.prototype.requestMatches = function(criteria, callback) {
    ...
    var payload = new Dota2.schema.CMsgDOTARequestMatches(Dota2._parseOptions(criteria, Dota2._matchOptions));
